...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_10 -L processing_system7_vip_v1_0_12 -L xil_defaultlib -L generic_baseblocks_v2_1_0 -L axi_register_slice_v2_1_24 -L fifo_generator_v13_2_5 -L axi_data_fifo_v2_1_23 -L axi_crossbar_v2_1_25 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_26 -L axi_protocol_converter_v2_1_24 -L axi_bram_ctrl_v4_1_5 -L blk_mem_gen_v8_4_4 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot system xil_defaultlib.system xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/ypwang/Tool/Vivado/2021.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
