...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../summer_lab_01.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../summer_lab_01.gen/sources_1/bd/system/ipshared/f42d/hdl" \
       +incdir+"../../../../summer_lab_01.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../summer_lab_01.gen/sources_1/bd/system/ipshared/f42d/hdl" \
       +incdir+"/home/ypwang/software/Vivado/2021.1/data/xilinx_vip/include"
}
