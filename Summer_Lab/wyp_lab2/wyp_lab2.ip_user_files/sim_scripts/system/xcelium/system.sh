...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../wyp_lab1.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../wyp_lab1.gen/sources_1/bd/system/ipshared/f42d/hdl" \
       +incdir+"../../../../wyp_lab1.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../wyp_lab1.gen/sources_1/bd/system/ipshared/f42d/hdl" \
